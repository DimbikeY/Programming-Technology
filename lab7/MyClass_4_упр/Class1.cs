...
namespace MyClass
{
    class Book: Item
    {
        ...
        // public string Publisher { get; set; } // объявление свойства
        public Publisher Publ { get; set; } // ссылка на класс
        ...
        {
            string bs = String.Format("\nКнига: \n Автор: {0}\n Название: {1}\n Год издания: {2}\n {3} стр.\n Стоимость аренды: {4}\n Издательство: {5}", Author, Title, Year, Pages, price, Publ.ToString()); // Book.price
            return bs;
        }
